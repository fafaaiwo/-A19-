<template>
	<view>
		...
		<view class="d-flex a-center j-sb py-2 px-3 text-light-muted">
			<view class="iconfont icon-guanbi1" @click="goBack"></view>
		...
		<view class="p-5">
			...
			<input type="text" password class="border-bottom mb-4 uni-input px-0"
			...
			<label class="checkbox d-flex a-center" @click="check = !check">
				<checkbox :checked="check" style="transform: scale(.6,.6); "/>
