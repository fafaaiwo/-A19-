<template>
	<view :class="disabled ? 'uni-list-item--disabled' : ''" :hover-class="disabled || showSwitch  || hideHover ? '' : 'uni-list-item--hover'" class="uni-list-item" @click="onClick">
		<view class="uni-list-item__container">
			...
			<view v-if="showBadge || showArrow || showSwitch" class="uni-list-item__extra" :style="'width:' + extraWidth + ';'">
				...
				<slot name="right">
					...
					<uni-icons v-if="showArrow && showArrowIcon" :size="16" class="uni-icon-wrapper" color="#bbb" type="arrowright" />
				</slot>
			</view>
		</view>
	</view>
